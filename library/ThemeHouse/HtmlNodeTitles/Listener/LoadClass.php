...
class ThemeHouse_HtmlNodeTitles_Listener_LoadClass extends ThemeHouse_Listener_LoadClass
{
    protected function _getExtendedClasses()
    {
        return array(
            'ThemeHouse_HtmlNodeTitles' => array(
                'model' => array(
                    'XenForo_Model_Node',
                ), /* END 'model' */
                'route_prefix' => array(
            ...
            ), /* END 'ThemeHouse_HtmlNodeTitles' */
        );
    } /* END _getExtendedClasses */

    public static function loadClassModel($class, array &$extend)
    {
        $loadClassModel = new ThemeHouse_HtmlNodeTitles_Listener_LoadClass($class, $extend, 'model');
        $extend = $loadClassModel->run();
    } /* END loadClassModel */

    public static function loadClassRoutePrefix($class, array &$extend)
    {
        $loadClassRoutePrefix = new ThemeHouse_HtmlNodeTitles_Listener_LoadClass($class, $extend, 'route_prefix');
        $extend = $loadClassRoutePrefix->run();
    } /* END loadClassRoutePrefix */

    public static function loadClassDataWriter($class, array &$extend)
    {
        $loadClassDataWriter = new ThemeHouse_HtmlNodeTitles_Listener_LoadClass($class, $extend, 'datawriter');
